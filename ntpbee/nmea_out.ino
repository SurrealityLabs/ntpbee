...
static bool enableZDA;
static bool enableGGA;
static bool enableGSA;
static bool enableRMC;

void nmea_init(bool zda, bool gga, bool gsa, bool rmc)
{
  enableZDA = zda;
  enableGGA = gga;
  enableGSA = gsa;
